                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Laporan <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Laporan Pemasukan</a></li>
                      <li><a href="form_advanced.html">Laporan Pengeluaran</a></li>
                      <li><a href="form_validation.html">Form Validation</a></li>
                    </ul>
                  </li>
                 
                  <li><a><i class="fa fa-clone"></i>User <span class=""></span></a>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6"><input id="nama_barang" type="text" name="nama_pemasukan" class="input-md  textinput textInput form-control" placeholder="Nama Pemasukan" required="true"></div>
                                  </div>
                                  <br>
                                  <div class="row">
                                    <div class="col-md-4 col-md-offset-1">Tanggal Pemasukan </div>
                                    <div class="col-md-6"><input id="datepicker" type="date" name="tanggal_pemasukan" class="form-control" placeholder="MM/DD/YYYY" required="true">
                                    </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6"><input id="harga" type="text" name="Jumlah Pemasukan" onkeyup="" class="input-md  textinput textInput form-control" placeholder="Jumlah Pemasukan" required="true"></div>
                                    
                                  </div>
                                  <br>
                                  <div class="row">
                                    <div class="col-md-4 col-md-offset-1">Keterangan</div>
                                    <div class="col-md-6"><input id="masa_manfaat" type="text" name="Keterangan" class="input-md  textinput textInput form-control" placeholder="Keterangan" required="true"></div>
                              ...
                              <div class="modal-body">
                                ...
                                <div class="col-md-12">
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6"><input id="nama_barang" type="text" name="nama_pengeluaran" class="input-md  textinput textInput form-control" placeholder="Nama Pengeluaran" required="true"></div>
                                  </div>
                                  <br>
                                  <div class="row">
                                    <div class="col-md-4 col-md-offset-1">Tanggal Pengeluaran </div>
                                    <div class="col-md-6"><input id="datepicker" type="date" name="tanggal_pengeluaran" class="form-control" placeholder="MM/DD/YYYY" required="true">
                                    </div>
                                  ...
                                  <div class="row">
                                    ...
                                    <div class="col-md-6"><input id="harga" type="text" name="Jumlah Pengeluaran" onkeyup="" class="input-md  textinput textInput form-control" placeholder="Jumlah Pengeluaran" required="true"></div>
